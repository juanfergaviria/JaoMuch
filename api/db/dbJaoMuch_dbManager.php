...
function getConnection() {
	...
	global $db_JaoMuch_db_Url, $db_JaoMuch_db_User, $db_JaoMuch_db_Pass, $db_JaoMuch_db_DbName;
	
	try {
		$dbh = new PDO("mysql:host=".$db_JaoMuch_db_Url.";dbname=".$db_JaoMuch_db_DbName, $db_JaoMuch_db_User, $db_JaoMuch_db_Pass);
